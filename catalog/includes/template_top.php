...
<link rel="stylesheet" type="text/css" href="stylesheet_freeoscommerce_012.css">
<link rel="stylesheet" type="text/css" href="stylesheet.css" />
<?php echo $oscTemplate->getBlocks('header_tags'); ?>
</head>
<body id="freeoscommerce_012">
...
?>
  <div id="wrapper2">
    ...
    <div id="header">
      <div id="website_name">
        <?php echo '<a href="' . tep_href_link(FILENAME_DEFAULT) . '">' . STORE_NAME . '</a>'; ?>
      </div>
    </div>
...
<?php
  if ($oscTemplate->hasBlocks('boxes_column_left')) 
  {
	...
	$boxes_column_left_search_modified = str_replace('button_quick_find.gif','button_quick_find_freeoscommerce_012.gif',$boxes_column_left_search_modified);
